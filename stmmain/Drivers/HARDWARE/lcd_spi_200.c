/***
   ...
   *  @description
	*
	*	实验平台：反客STM32F407VET6核心板 （型号：FK407M3-VET6）+ 2.00寸液晶模块（型号：SPI200M1-240*320）
...
void LCD_Test_Clear(void)
{
	...
	LCD_SetTextFont(&ASCII_Font24);			// 设置2424中文字体,ASCII字体对应为2412
	...
	for(i=0;i<8;i++)
	{
		...
		LCD_DisplayText(13,106,"240*320");
